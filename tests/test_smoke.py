"""Import-smoke + pure-function tests for gemini-rigor-framework (Bucket-B no-tests remediation).
...
def _load():
    ...
    spec = importlib.util.spec_from_file_location("buildmod_gemini_rigor_framework", _SCRIPT)
